...
function parse_log_file($filename, &$closed_connections, $std_dev = false) {
        ...
        if ($action == 'new') {
            ...
            if (isset($open_connections[$key]) && count($open_connections[$key])) {
                ...
                if ($std_dev == false) {
                    ...
                    $closed_connections[$key]['std_dev_sum'] += pow(($closed_connections[$key]['mean']  - $closed_connections[$key]['total_time']), 2);
                }
